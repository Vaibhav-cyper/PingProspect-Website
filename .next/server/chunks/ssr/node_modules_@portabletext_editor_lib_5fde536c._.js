...
const arrowDownOnLonelyBlockObject = {
    ...
    on: "mouse.click",
    guard: ({ snapshot, event })=>{
        if (snapshot.context.readOnly || snapshot.context.selection && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$selector$2e$is$2d$overlapping$2d$selection$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSelectionCollapsed"])(snapshot)) return !1;
        const focusBlockObject = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$selector$2e$is$2d$overlapping$2d$selection$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFocusBlockObject"])({
            context: {
                ...snapshot.context,
                selection: event.position.selection
            }
        }), previousBlock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$selector$2e$is$2d$overlapping$2d$selection$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPreviousBlock"])({
            context: {
                ...snapshot.context,
                selection: event.position.selection
            }
    ...
    guard: ({ snapshot, event })=>{
        ...
        }), nextBlock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$selector$2e$is$2d$overlapping$2d$selection$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getNextBlock"])({
            context: {
                ...snapshot.context,
                selection: event.position.selection
            }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/slate-react/dist/index.es.js [app-ssr] (ecmascript) <locals>");
    ...
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].setNodes(slateEditor, currentBlock, {
        ...
        currentBlock.children.length < oldBlockChildrenLength && Array.from(Array(oldBlockChildrenLength - currentBlock.children.length)).forEach((_, index)=>{
            ...
            if (isChildChanged) if (currentBlockChild._key === oldBlockChild?._key) {
                ...
                isSpanNode && isTextChanged ? (oldBlockChild.text.length > 0 && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].delete(slateEditor, {
                    at: {
                        focus: {
                            path,
                            offset: 0
...
const converterJson = {
    ...
    deserialize: ({ snapshot, event })=>{
        const parsedBlocks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$block$2d$tools$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["htmlToBlocks"])(event.data, snapshot.context.schema.portableText, {
...
`),
    ...
    deserialize: ({ snapshot, event })=>{
        const textToHtml = `<html><body>${escapeHtml(event.data).split(/\n{2,}/).map((line)=>line ? `<p>${line.replace(/(?:\r\n|\r|\n)/g, "<br/>")}</p>` : "<p></p>").join("")}</body></html>`, parsedBlocks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$block$2d$tools$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["htmlToBlocks"])(textToHtml, snapshot.context.schema.portableText, {
            keyGenerator: snapshot.context.keyGenerator
        }).flatMap((block)=>{
            const parsedBlock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$parse$2d$blocks$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseBlock"])({
                context: snapshot.context,
...
const addAnnotationActionImplementation = ({ context, action })=>{
    ...
    const editor = action.editor;
    if (editor.selection) if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Range"].isCollapsed(editor.selection)) {
...
const blockSetBehaviorActionImplementation = ({ context, action })=>{
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactEditor"].blur(action.editor);
};
function getFocusBlock({ editor }) {
    ...
    try {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Editor"].node(editor, editor.selection.focus.path.slice(0, 1)) ?? [
            void 0,
            void 0
        ];
    } catch  {
...
function getPointBlock({ editor, point }) {
    try {
        const [block] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Editor"].node(editor, point.path.slice(0, 1)) ?? [
            void 0,
            void 0
        ];
        return block ? [
...
function getPointChild({ editor, point }) {
    ...
    try {
        const pointChild = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Node"].child(block, childIndex);
        return pointChild ? [
            pointChild,
            [
                ...blockPath,
...
function slateRangeToSelection({ schema, editor, range }) {
    ...
    const [anchorChild] = anchorBlock._type === schema.block.name ? getPointChild({
        ...
        backward: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Range"].isBackward(range)
    };
...
const decoratorAddActionImplementation = ({ context, action })=>{
    ...
    const editorSelection = slateRangeToSelection({
        ...
        editor,
        range: selection
    }), anchorOffset = editorSelection ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$util$2e$selection$2d$point$2d$to$2d$block$2d$offset$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["selectionPointToBlockOffset"])({
        value,
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactEditor"].focus(action.editor);
...
function performAction({ context, action }) {
    switch(debug$a(JSON.stringify((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$omit$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(action, [
        "editor"
    ]), null, 2)), action.type){
        case "annotation.add":
            {
...
function insertPatch(editor, patch, schemaTypes) {
    ...
    if (patch.path.length === 1) {
        ...
        return debug$9(`Inserting blocks at path [${normalizedIdx2}]`), debugState(editor, "before"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].insertNodes(editor, blocksToInsert, {
            at: [
                normalizedIdx2
            ]
...
function unsetPatch(editor, patch) {
    ...
    if (patch.path.length === 1) {
        ...
        return debug$9(`Removing block at path [${blockIndex}]`), debugState(editor, "before"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].removeNodes(editor, {
            at: [
                blockIndex
            ]
        }), debugState(editor, "after"), !0;
        ...
        return editor.apply = (op)=>{
            ...
            if (op.type === "remove_node") {
                ...
                if (op.path[0] === 0 && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Editor"].isVoid(editor, node)) {
                    ...
                    editor.children[nextPath[0]] || (debug$7("Adding placeholder block"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Editor"].insertNode(editor, editor.pteCreateTextBlock({
                        decorators: []
                    })));
                }
            }
...
const abstractAnnotationBehaviors = [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$behavior$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defineBehavior"])({
        on: "move.block up",
        guard: ({ snapshot, event })=>{
            const previousBlock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$selector$2e$is$2d$overlapping$2d$selection$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPreviousBlock"])({
                context: {
                    ...snapshot.context,
                    selection: {
                        anchor: {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$behavior$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defineBehavior"])({
        on: "move.block down",
        guard: ({ snapshot, event })=>{
            const nextBlock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$selector$2e$is$2d$overlapping$2d$selection$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getNextBlock"])({
                context: {
                    ...snapshot.context,
                    selection: {
                        anchor: {
...
function useEditorSelector(editor, selector, t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(3), compare = t0 === void 0 ? defaultCompare : t0;
    let t1;
    ...
    return {
        ...
        findDOMNode: (element)=>{
            ...
            try {
                ...
                node = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactEditor"].toDOMNode(editor, item);
            } catch  {}
            return node;
        },
        activeAnnotations: ()=>{
            ...
            if (selection) {
                ...
                if (range) {
                    if (!options?.mode || options?.mode === "selected") {
                        debug$2("Deleting content in selection"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].delete(editor, {
                            at: range,
                            hanging: !0,
                            voids: !0
                        }), editor.onChange();
                    ...
                    options?.mode === "blocks" && (debug$2("Deleting blocks touched by selection"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].removeNodes(editor, {
                        at: range,
                        voids: !0,
                    ...
                    })), options?.mode === "children" && (debug$2("Deleting children touched by selection"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].removeNodes(editor, {
                        at: range,
                        voids: !0,
...
const EditorActorContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])({}), PortableTextEditorContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(null), usePortableTextEditor = ()=>{
    ...
    return editor;
}, PortableTextEditorSelectionContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(null), usePortableTextEditorSelection = ()=>{
        ...
        return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxs"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                ...
                /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(EditorActorContext.Provider, {
                    ...
                    children: /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Slate"], {
...
function getEventSelection({ schema, slateEditor, event }) {
    ...
    return range ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["slateRangeToSelection"])({
        schema,
        editor: slateEditor,
        range
    }) : null;
...
function DropIndicator() {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(1);
    let t0;
...
const slateOperationCallback = ({ input, sendBack })=>{
...
}, rangeDecorationsMachine = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$xstate$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["setup"])({
    types: {
        context: {},
        input: {},
        events: {}
    ...
    actions: {
        "update pending range decorations": (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$log$2d$0acd9069$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a__as__assign$3e$__["assign"])({
            pendingRangeDecorations: ({ event })=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$xstate$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["assertEvent"])(event, "range decorations updated"), event.rangeDecorations)
        }),
        "set up initial range decorations": (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$log$2d$0acd9069$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a__as__assign$3e$__["assign"])({
            decoratedRanges: ({ context, event })=>{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$xstate$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["assertEvent"])(event, "ready");
                const rangeDecorationState = [];
                for (const rangeDecoration of context.pendingRangeDecorations){
                    const slateRange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toSlateRange"])(rangeDecoration.selection, context.slateEditor);
                    if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Range"].isRange(slateRange)) {
        ...
        "update range decorations": (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$log$2d$0acd9069$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a__as__assign$3e$__["assign"])({
            decoratedRanges: ({ context, event })=>{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$xstate$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["assertEvent"])(event, "range decorations updated");
                const rangeDecorationState = [];
        ...
        "move range decorations": (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$log$2d$0acd9069$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a__as__assign$3e$__["assign"])({
            decoratedRanges: ({ context, event })=>{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$xstate$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["assertEvent"])(event, "slate operation");
                const rangeDecorationState = [];
                for (const decoratedRange of context.decoratedRanges){
                    const slateRange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toSlateRange"])(decoratedRange.rangeDecoration.selection, context.slateEditor);
                    if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Range"].isRange(slateRange)) {
                    ...
                    let newRange;
                    if (newRange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["moveRangeByOperation"])(slateRange, event.operation), newRange && newRange !== slateRange || newRange === null && slateRange) {
                        const newRangeSelection = newRange ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["slateRangeToSelection"])({
                            schema: context.schema,
                    ...
                    newRange !== null && rangeDecorationState.push({
                        ...
                        rangeDecoration: {
                            ...
                            selection: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["slateRangeToSelection"])({
                                schema: context.schema,
                                editor: context.slateEditor,
                                range: newRange
                            })
        ...
        "assign readOnly": (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$log$2d$0acd9069$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a__as__assign$3e$__["assign"])({
            readOnly: ({ event })=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$xstate$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["assertEvent"])(event, "update read only"), event.readOnly)
        }),
        "increment update count": (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$log$2d$0acd9069$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a__as__assign$3e$__["assign"])({
            updateCount: ({ context })=>context.updateCount + 1
        })
    },
    actors: {
        "slate operation listener": (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$actors$2f$dist$2f$xstate$2d$actors$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fromCallback"])(slateOperationCallback)
    },
    guards: {
        ...
        "has different decorations": ({ context, event })=>{
            ...
            return !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isEqual$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(existingRangeDecorations, newRangeDecorations);
        },
...
function createDecorate(rangeDecorationActor) {
    return function([node, path]) {
        ...
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Element"].isElement(node) || node.children.length === 0) return [];
        const blockIndex = path.at(0);
        return blockIndex === void 0 ? [] : rangeDecorationActor.getSnapshot().context.decoratedRanges.filter((decoratedRange)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Range"].isCollapsed(decoratedRange) ? node.children.some((_, childIndex)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Path"].equals(decoratedRange.anchor.path, [
                    blockIndex,
                    childIndex
                ]) && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Path"].equals(decoratedRange.focus.path, [
                    blockIndex,
                    childIndex
                ])) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Range"].intersection(decoratedRange, {
                anchor: {
                    path,
                    offset: 0
                },
            ...
            }) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Range"].includes(decoratedRange, path));
    };
}
const debug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debugWithName"])("component:Editable"), PLACEHOLDER_STYLE = {
    ...
    const editorActor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EditorActorContext"]), readOnly = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xstate$2f$react$2f$dist$2f$xstate$2d$react$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSelector"])(editorActor, (s)=>s.matches({
            "edit mode": "read only"
        })), schemaTypes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xstate$2f$react$2f$dist$2f$xstate$2d$react$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSelector"])(editorActor, (s_0)=>s_0.context.schema), slateEditor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useSlate"])(), rangeDecorationsActor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xstate$2f$react$2f$dist$2f$xstate$2d$react$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useActorRef"])(rangeDecorationsMachine, {
        input: {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xstate$2f$react$2f$dist$2f$xstate$2d$react$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSelector"])(rangeDecorationsActor, (s_1)=>s_1.context.updateCount);
    const decorate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>createDecorate(rangeDecorationsActor), [
    ...
    const handleCopy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((event)=>{
        if (onCopy) onCopy(event) !== void 0 && event.preventDefault();
            ...
            const selection = slateEditor.selection ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["slateRangeToSelection"])({
                schema: editorActor.getSnapshot().context.schema,
                editor: slateEditor,
        ...
        const root = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactEditor"].findDocumentOrShadowRoot(slateEditor), { activeElement } = root;
        if (ref.current !== activeElement) return;
        const domSelection = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactEditor"].getWindow(slateEditor).getSelection();
        if (!domSelection || domSelection.rangeCount === 0) return;
        const existingDOMRange = domSelection.getRangeAt(0);
        try {
            const newDOMRange = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactEditor"].toDOMRange(slateEditor, slateEditor.selection);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ref.current = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactEditor"].toDOMNode(slateEditor, slateEditor), setEditableElement(ref.current);
    }, [
        slateEditor,
        ref
    ]), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const window_0 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactEditor"].getWindow(slateEditor), onDragEnd_0 = ()=>{
            editorActor.send({
                type: "dragend"
            });
        }, onDrop_0 = ()=>{
