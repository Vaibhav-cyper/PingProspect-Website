      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            ...
            <button className="px-4 py-2 cursor-pointer border border-transparent text-sm font-medium rounded-md text-white font-medium hover:bg-white hover:text-blue-600 text-blue-600 flex items-center gap-2 transition transform hover:scale-105">
              Download Now
